        ...
        <table id="showListTable${cur_list_type}" class="tablesorter ${'fanartOpacity' if app.FANART_BACKGROUND else ''}" cellspacing="1" border="0" cellpadding="0">
            ...
            % if app.show_queue_scheduler.action.loading_show_list:
                ...
                % for cur_loading_show in app.show_queue_scheduler.action.loading_show_list:
                    ...
                    <tr>
                        ...
                        % else:
                        <a href="display_series?indexername=${cur_loading_show.series.indexer_name}&seriesid=${cur_loading_show.series.series_id}">${cur_loading_show.show.name}</a>
                        % endif
                        </td>
                        <td></td>
                        <td></td>
            ...
            %>
                ...
                % else:
                    <td align="center" class="nowrap triggerhighlight"></td>
                % endif
                    <td class="tvShow triggerhighlight"><a href="home/display_series?indexername=${cur_show.indexer_name}&seriesid=${cur_show.series_id}">${cur_show.name}</a></td>
