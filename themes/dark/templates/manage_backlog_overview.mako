                    ...
                    <td class="row-seasonheader" colspan="5" style="vertical-align: bottom; width: auto;">
                        <div class="col-md-12">
                            <div class="col-md-6 left-30">
                                <h3 style="display: inline;"><a href="home/display_series?indexername=${cur_show.indexer_name}&seriesid=${cur_show.series_id}">${cur_show.name}</a></h3>
                            ...
                            <div class="col-md-6 pull-right right-30">
                                <div class="top-5 bottom-5 pull-right">
                                    ...
                                    % endif
                                    <a class="btn btn-inline force_backlog" href="manage/backlogShow?indexername=${cur_show.indexer_name}&seriesid=${cur_show.series_id}"><i class="icon-play-circle icon-white"></i> Force Backlog</a>
